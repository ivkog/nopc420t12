...
namespace Nop.Plugin.Widgets.Product_Msg.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Setting>>
    {
        ...
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "Nop.plugins.widgets.product_msg.pictureurl-{0}-{1}";
        public const string PICTURE_URL_PATTERN_KEY = "Nop.plugins.widgets.product_msg";
