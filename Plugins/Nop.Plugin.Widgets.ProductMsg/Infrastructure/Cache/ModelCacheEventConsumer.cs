...
namespace Nop.Plugin.Widgets.ProductMsg.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Setting>>
    {
        ...
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "Nop.plugins.widgets.productmsg.pictureurl-{0}-{1}";
        public const string PICTURE_URL_PATTERN_KEY = "Nop.plugins.widgets.productmsg";
